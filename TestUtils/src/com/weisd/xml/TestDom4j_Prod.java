...
public class TestDom4j_Prod {
	...
	public static void main(String[] args) {
		...
		try {
			...
			document = reader.read(new File("D:\\junbao_newpro\\TestUtils\\src\\com\\weisd\\xml\\prod.xml"));
		...
		Element root = (Element) document.selectSingleNode("allproducts");
		if (null != root) {
			// 方法1
