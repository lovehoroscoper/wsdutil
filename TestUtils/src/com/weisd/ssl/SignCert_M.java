...
public class SignCert_M {
	public static void main(String[] args) throws Exception {
		...
		char[] afterNewPass = "changeit".toCharArray();
		// 签名后新产生的被签过名的证书在库的条目的私钥的密码
		// 装载证书库
		FileInputStream in = new FileInputStream("D:\\JDK\\jdk1.6.0_10\\weisdkeystore\\" + name);
		...
		X500Name issuer = (X500Name) cinfo_first.get(X509CertInfo.SUBJECT + "." + CertificateIssuerName.DN_NAME);
		// 获取待签发的证书，即获取被签发者的证书
		...
		X509CertInfo cinfo_second = (X509CertInfo) cimp3.get(X509CertImpl.NAME + "." + X509CertImpl.INFO); // /////////////////////////////////////////////////////////////////////////
		...
		cinfo_second.set(CertificateAlgorithmId.NAME + "." + CertificateAlgorithmId.ALGORITHM, algorithm);
		...
		FileOutputStream out2 = new FileOutputStream("D:\\JDK\\jdk1.6.0_10\\weisdkeystore\\" + name);
