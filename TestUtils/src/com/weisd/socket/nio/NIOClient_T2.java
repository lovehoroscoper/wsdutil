...
//						System.out.println("客户端接受服务器端数据--[" + receiveText.length() + "]" + receiveText);
//						client.register(selector, SelectionKey.OP_WRITE);
//					}
//					int aa = receivebuffer.remaining();
//					boolean has = receivebuffer.hasRemaining();
//					System.out.println("remaining--[" + aa + "]");
//					System.out.println("hasRemaining--[" + has + "]");
