...
public class Receiver2 {
	...
	public void execute() throws Exception {
		// 连接工厂
		ConnectionFactory connFactory = new ActiveMQConnectionFactory(ActiveMQConnection.DEFAULT_USER, ActiveMQConnection.DEFAULT_PASSWORD, "tcp://192.168.1.100:6161");
		...
		Destination destination = session.createQueue("ebs_async_res");
