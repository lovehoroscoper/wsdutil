package org.godtips.sso.user.cache;
...
public class UserCacheManager {
	...
	private static Logger logger = LoggerFactory.getLogger(UserCacheManager.class);
	...
	public void setCacheManager(CacheManager cacheManager) {
		...
		UserCacheManager.cacheManager = cacheManager;
	}
