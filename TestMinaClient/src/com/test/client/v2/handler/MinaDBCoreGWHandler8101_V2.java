package com.test.client.v2.handler;
...
public class MinaDBCoreGWHandler8101_V2 extends IoHandlerAdapter{
	private static Log logger = LogFactory.getLog(MinaDBCoreGWHandler8101_V2.class);
