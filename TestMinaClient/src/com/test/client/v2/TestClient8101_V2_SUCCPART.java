 ...
 * 
 */
public class TestClient8101_V2_SUCCPART {
	...
	public static void main(String[] args) {
		...
		String hfserialid = "HF011205141519184822";
		String sendserialid = "s_" + dateTime;
		String channelserialid = "c_" + dateTime;
		String dealtime = dateTime;
		String dealamount = "5000";
		String resultno = "1009";
		String resultmsg = "部分成功";
		String othererrorcode = "1009";
