...
//				finishtime
				...
				String req = "comm=8003&version=1.0&agentid=DE_WEISD&ordersource=1&czserialid=" + czserialid + "&hforderid=" + orderid + "&hfserialid=" + hfserialid + "&accnum=" + mobilenum + "&amount=" + chargeamount
