 ...
 * 
 */
public class HeartBeatTestClient2 extends Thread{

	private static final Logger LOG = LoggerFactory
			.getLogger(HeartBeatTestClient2.class);
...
//	private static final String IPADDRESS = "127.0.0.1";
	private static final String IPADDRESS = "192.168.2.95";

	private static NioSocketConnector connector;
	private static IoHandler handler = new HeartBeatClientHandler();
	
	public static void main(String[] args) {
		HeartBeatTestClient2 t = new HeartBeatTestClient2();
		t.start();
	}
...
//			connector.getFilterChain().addLast("heartbeat", heartBeat);
			...
			ConnectFuture future = cf.awaitUninterruptibly();
			IoSession session = future.getSession();
			session.write("HEARTBEAT_REQUEST").awaitUninterruptibly();
			LOG.info("客户端已连接上！");
	...
	private static class KeepAliveMessageFactoryImpl implements
		...
		public static final Object HEARTBEAT_REQUEST = null;
