 ...
 * 
 */
public class TestClient8001_Web_2_qd_DX3_Login_3 {
...
//			String ip = "172.25.61.79";
			...
			for (int i = 0; i < 1; i++) {
				...
				String verifycode = "112";
//				String req = "comm=login&imgname=20120710193319_1.jpg&logintype=0&loginstep=3&verifycode=" + verifycode;
				String req = "comm=login&imgname=&logintype=0&loginstep=3&mustset=&verifycode=" + verifycode;
