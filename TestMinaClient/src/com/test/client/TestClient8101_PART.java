 ...
 * 
 */
public class TestClient8101_PART {
	...
	public static void main(String[] args) {
		...
		String ss =		
				...
				"HF011112220959023212,"+
						"HF011112220959023213,"+
						"HF011112220959043214,"+
						"HF011112220959043215";
		...
		for (int i = 0; i < a.length; i++) {
			...
			String req = "comm=8101&version=1.0&hfserialid=" + a[i] + "&channelserialid=weisdTest" + i + "&dealtime=&dealamount=3000&sendserialid=&resultno=1009";
			session.write(req);
			try {
				Thread.sleep(100);
