...
Ajax.JSONResponse = Class.create({
  ...
  (function(){
    ...
    function init_notification_menu() {
      ...
      notifications_summary.update('<div class="menu_title clearfix"><span class="title">提醒</span><span class="all"><a href="http://app.iteye.com/notifications">查看所有 »</a></span></div>');
