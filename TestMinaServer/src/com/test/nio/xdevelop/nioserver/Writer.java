package com.test.nio.xdevelop.nioserver;
...
//            演示程序（ nioserver.zip）中写线程（Writer）类中关闭socket资源的时候，在write(SelectionKey key)方法中的顺序应该是这样的吧：
//         // 触发onClosed事件
...
//         sc.socket().close();
//         sc.close();
//         	源代码中 notifier.fireOnClosed((Request)key.attachment());放在了sc.close();之后。
