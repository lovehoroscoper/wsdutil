...
//
//public class JbczBackServiceImplBizV3 {
//	private static Logger logger = Logger.getLogger(JbczBackServiceImplBizV3.class);
//
//	private static JbczBackServiceImplBizV3 backServiceImplBiz;
//
//	public static JbczBackServiceImplBizV3 getInstance() {
...
//		String className = "backServiceImplBizV3";
//		logger.info("开始加载渠道处理类配置信息");
//		try {
//			backServiceImplBiz = (JbczBackServiceImplBizV3) SpringBeanFactoryHolder.getBean(className);
//		} catch (Exception e) {
//			logger.error("加载渠道处理类配置文件:" + className + "|error:" + e.getMessage());
//		}
//	}
//
//	public TaskBean dealMessage(String returnMsg) {
//		if (!StringUtils.isEmptyOrNullByTrim(returnMsg) && returnMsg.length() > 3) {
//			try {
//				List<String> msgList = splitMsg(returnMsg);
...
//					}
//				} else {
//					logger.error("切割返回消息为空:" + returnMsg);
//				}
//			} catch (Exception e) {
//				logger.error("切割返回消息异常:" + returnMsg);
//			}
//		} else {
//			logger.error("消息为空或者长度不对:" + returnMsg);
//		}
//		return null;
//	}
//
