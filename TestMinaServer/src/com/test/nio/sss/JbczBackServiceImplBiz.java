...
//
//public class JbczBackServiceImplBiz {
//	private static Logger logger = Logger.getLogger(JbczBackServiceImplBiz.class);
//
//	private static JbczBackServiceImplBiz backServiceImplBiz;
//
//	public static JbczBackServiceImplBiz getInstance() {
...
//		String className = "backServiceImplBiz";
//		logger.info("开始加载渠道处理类配置信息");
//		try {
//			backServiceImplBiz = (JbczBackServiceImplBiz) SpringBeanFactoryHolder.getBean(className);
//		} catch (Exception e) {
