...
//		String type = msg.substring(MessageRequest.len_header, MessageRequest.len_header + 4);
//		String backmsg = "";
//		
...
//		Thread.sleep(2 * 1000);
//		
//		// String body = getMsgBody(message, taskBean.getUniqueSno());
//		String header = MessageRequest.getMsgHeader(MessageRequest.len_header + len_body);
//		
