 ...
 * 
 */
public class MinaServerHandler_KONG extends IoHandlerAdapter {

	private static Logger logger = Logger.getLogger(MinaServerHandler_KONG.class);
