...
<title>新标签页</title>
<link rel="stylesheet" href="<c:url value="/css/ntab.css"/>">
<style type="text/css">
html {
														...
														<div>
															<a draggable="false" onclick="quickDial.onclickdial(2);" href="http://www.baidu.com/index.php">
																<div style="height: 100%; width: 100%; 
																		background: url(../images/showplat/baidu.png) no-repeat scroll center 0 transparent"
																		class="">
																</div>
															</a>
														</div>
													...
													<div>
														<div>
															<a draggable="false" onclick="quickDial.onclickdial(3);" href="http://www.sina.com.cn/">
																<div style="height: 100%; width: 100%; background: url(../images/showplat/sina.png) no-repeat scroll center 0 transparent"
																		class="">
																</div>
															</a>
														</div>
