  ...
  <tr>
    <td height="400" align="center" bgcolor="#F0F8FD"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left"><input name="dbName" type="text" class="input" id="dbName" value="jeebbs_2_1_0_beta" /></td>
				<td align="left">&nbsp;</td>
      </tr>
      <tr>
...
<input type="hidden" name="dbFileName" value="/install/db/jeebbs-db-2.1.0-beta.sql"/>
<input type="hidden" name="initFileName" value="/install/db/jeebbs-init-2.1.0-beta.sql"/>
</form>
</body>
</html>
