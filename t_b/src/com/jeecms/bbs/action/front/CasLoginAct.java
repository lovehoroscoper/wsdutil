...
public class CasLoginAct {
	...
	public String submit(String username, String password,String captcha, String processUrl,String cookieType,
...
//	                0 永久
	...
	private WebErrors validateSubmit(String username, String password,
			HttpServletRequest request,String captcha,HttpServletResponse response) {
