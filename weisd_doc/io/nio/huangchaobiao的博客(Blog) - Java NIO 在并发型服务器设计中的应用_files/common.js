...
function login()
{
	window.location="http://login.chinajavaworld.com/login!default.jspa?error=3&successURL="+escape(document.URL);
}

function logout()
{
	window.location="logout.jspa?url="+escape(document.URL);
}